...
import { currentMonthValue, getWorkExperienceDateErrors } from '../../../utils/workExperienceDates';
  ...
  return (
    <>
      ...
      {workExperience.map((exp, expIndex) => {
        const dateErrors = getWorkExperienceDateErrors(exp);
        return (
            ...
            <Grid container spacing={2} sx={{ mb: 2 }}>
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  onChange={(e) => {
                    const updatedExperience = [...workExperience];
                    updatedExperience[expIndex].start_date = e.target.value;
                    setWorkExperience(updatedExperience);
                  }}
                  variant="outlined"
                  size="small"
                  slotProps={{ htmlInput: { max: exp.end_date || currentMonthValue() } }}
                  error={Boolean(dateErrors.startDate)}
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  onChange={(e) => {
                    const updatedExperience = [...workExperience];
                    updatedExperience[expIndex].end_date = e.target.value;
                    setWorkExperience(updatedExperience);
                  }}
                  variant="outlined"
                  size="small"
                  ...
                  error={Boolean(dateErrors.endDate)}
                    ...
                    <Checkbox
                      ...
                      onChange={(e) => {
                        ...
                        updatedExperience[expIndex] = {
                          ...
                          end_date: e.target.checked ? '' : updatedExperience[expIndex].end_date,
                        };
                        setWorkExperience(updatedExperience);
                      }}
                    />
